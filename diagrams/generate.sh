...
| jq -r '{buildbase: "<< (β,#6495ED) >>", layerbase: "<< (λ,#98FB98) >>", layers: "<< (ℒ,#9ACD32) >>", libs: "<< (l,#FF7700) >>", apps: "<< (a,#FF00FF) >>", utils: "<< (u,#4B0082) >>", fonts: "<< (f,#48D1CC) >>", development: "<< (d,#D4AC0D) >>", entity: "<< (e,#5DADE2) >>"} as $packages_styles
